...
func Build(info *depslib.DependencyInfo, artifactTypeOverride depslib.ArtifactType) ([]string, error) {
	...
	return depsbuild.Build(flags, sourceLibs, includePaths, defines, linkFlags)
}
